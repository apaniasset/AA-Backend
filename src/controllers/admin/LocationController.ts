...
export class LocationController {
    ...
    static async addCountry(req: Request, res: Response) {
        try {
            if (!req.body.name) return ApiResponse.error(res, 'Name is required', 400);
    ...
    static async updateCountry(req: Request, res: Response) {
        try {
            ...
            if (!updated) return ApiResponse.error(res, 'Country not found', 404);
    ...
    static async deleteCountry(req: Request, res: Response) {
        try {
            ...
            if (!deleted) return ApiResponse.error(res, 'Country not found', 404);
    ...
    static async addState(req: Request, res: Response) {
        try {
            if (!req.body.state_name || !req.body.country_id) return ApiResponse.error(res, 'Name and Country ID are required', 400);
    ...
    static async updateState(req: Request, res: Response) {
        try {
            ...
            if (!updated) return ApiResponse.error(res, 'State not found', 404);
    ...
    static async deleteState(req: Request, res: Response) {
        try {
            ...
            if (!deleted) return ApiResponse.error(res, 'State not found', 404);
    ...
    static async addCity(req: Request, res: Response) {
        try {
            if (!req.body.city_name || !req.body.state_id) return ApiResponse.error(res, 'Name and State ID are required', 400);
    ...
    static async updateCity(req: Request, res: Response) {
        try {
            ...
            if (!updated) return ApiResponse.error(res, 'City not found', 404);
    ...
    static async deleteCity(req: Request, res: Response) {
        try {
            ...
            if (!deleted) return ApiResponse.error(res, 'City not found', 404);
    ...
    static async addArea(req: Request, res: Response) {
        try {
            if (!req.body.area_name || !req.body.city_id) return ApiResponse.error(res, 'Name and City ID are required', 400);
    ...
    static async updateArea(req: Request, res: Response) {
        try {
            ...
            if (!updated) return ApiResponse.error(res, 'Area not found', 404);
    ...
    static async deleteArea(req: Request, res: Response) {
        try {
            ...
            if (!deleted) return ApiResponse.error(res, 'Area not found', 404);
