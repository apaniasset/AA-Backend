...
// --- Countries ---
export const getCountries = (req, res) => handleCRUD(res, () => Country.getAll(req.query), 'Countries fetched');
...
// --- States ---
export const getStates = (req, res) => handleCRUD(res, () => State.getAll(req.query), 'States fetched');
export const getStatesByCountry = (req, res) => handleCRUD(res, () => State.getByCountryId(req.params.countryId, req.query), 'States fetched');
...
// --- Cities ---
export const getCities = (req, res) => handleCRUD(res, () => City.getAll(req.query), 'Cities fetched');
export const getCitiesByState = (req, res) => handleCRUD(res, () => City.getByStateId(req.params.stateId, req.query), 'Cities fetched');
...
// --- Locations ---
export const getLocations = (req, res) => handleCRUD(res, () => Location.getAll(req.query), 'Locations fetched');
export const getLocationsByCity = (req, res) => handleCRUD(res, () => Location.getByCityId(req.params.cityId, req.query), 'Locations fetched');
